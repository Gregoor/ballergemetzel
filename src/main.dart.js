...
$$.Closure$mainLoop = {"": "Closure;call$1,$name"};
...
HashSet__newHashTable: function() {
...
["level", "models/level.dart", , {
Level: {"": "Object;width,height,planets<,gravity",
  gravityAt$1: function(pos) {
    var t1 = {};
    t1.grav_0 = null;
    $.IterableMixinWorkaround_forEach(this.planets, new $.Level_gravityAt_closure(t1, pos));
    return t1.grav_0;
  },
  planetAt$1: function(v) {
    return $.IterableMixinWorkaround_any(this.planets, new $.Level_planetAt_closure(v));
  },
  Level$0: function() {
    $.IterableMixinWorkaround_forEach([new $.Planet($.Vector$(-1600, -1800), 600, "blue"), new $.Planet($.Vector$(-800, 1200), 300, "darkred"), new $.Planet($.Vector$(900, -1400), 400, "green"), new $.Planet($.Vector$(1500, 1400), 700, "darkorange"), new $.Planet($.Vector$(4000, 700), 400, "pink")], new $.Level_closure(this));
    return;
  },
  static: {
"": "Level_GRID_SIZE,Level_BIG_G",
Level$: function() {
  var t1 = new $.Level(10000, 5000, [], null);
  t1.Level$0();
  return t1;
}}
...
Level_closure: {"": "Closure;this_1",
  call$1: function(p) {
    this.this_1.get$planets().push(p);
  }
},

Level_gravityAt_closure: {"": "Closure;box_0,pos_1",
  call$1: function(planet) {
    var dist, t1, t2, t3, grav;
    dist = planet.surfaceTo$1(this.pos_1);
    t1 = dist.normalize$0();
    t1 = t1.$mul(t1, 0.001);
    t2 = planet.get$mass();
    t3 = dist.get$length(dist);
    if (typeof t3 !== "number")
      $.throwExpression(new $.ArgumentError(t3));
    dist = t1.$mul(t1, t2 / Math.pow(t3, 2));
    t1 = this.box_0;
    t2 = t1.grav_0;
    if (t2 == null)
      grav = dist;
      ...
      t3 = dist.$sub(dist, t2);
      grav = $.$add$ns(t2, t3.$mul(t3, 0.5));
    }
    t1.grav_0 = grav;
  }
},

Level_planetAt_closure: {"": "Closure;v_0",
  call$1: function(p) {
    var t1, t2;
    t1 = $.get$length$asx($.$sub$n(this.v_0, p.get$pos()));
    t2 = $.get$r$x(p);
    if (t1 == null)
      throw t1.$le();
    if (typeof t2 !== "number")
...
Planet: {"": "Object;pos<,r>,color>",
  get$mass: function() {
    var t1 = this.r;
    return 4.1887902047863905 * Math.pow(t1, 3);
  },
  surfaceTo$1: function(v) {
    var t1, dist;
    t1 = this.pos;
    dist = t1.$sub(t1, v);
    t1 = dist.get$length(dist);
    if (t1 == null)
      throw t1.$le();
    return t1 <= this.r ? dist.normalize$0() : dist;
  }
}}],
["main", "main.dart", , {
main: function() {
  ...
  t3.set$width(t1, t2 - 30);
  t2 = window.innerHeight;
  if (t2 == null)
    throw t2.$sub();
  t3.set$height(t1, t2 - 30);
  t2 = t1.style;
  t2.set$border;
  $.setProperty$3$x(t2, "border", "1px solid black", "");
  t1 = t1.style;
  t1.set$position;
  $.setProperty$3$x(t1, "position", "absolute", "");
  $.debugCanvas = $.canvas.cloneNode(false);
  t1 = document.querySelector("#game-container");
  t1.appendChild($.debugCanvas);
  t1.appendChild($.canvas);
  t1 = window;
  $.EventStreamProvider_keydown.forTarget$2$useCapture;
  t1 = new $._EventStream(t1, $.EventStreamProvider_keydown._eventType, false);
  ...
  t1 = new $._EventStream(t1, $.EventStreamProvider_keyup._eventType, false);
  new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.main_closure0(), t1._useCapture)._tryResume$0();
  $.mainLoop(0);
},
...
mainLoop: function(time) {
  ...
  if (typeof time !== "number")
    return $.mainLoop$bailout(1, time);
  if ($.exit) {
    window.document.title = "SPIEL AUS";
    return;
  }
  t1 = $.prevTime;
  if (typeof t1 !== "number")
    return $.mainLoop$bailout(2, time, t1);
  delta = time - t1;
  $.prevTime = time;
  $.get$level();
  $.get$p1().act$1(delta);
  ...
  $.Window_methods._requestAnimationFrame$1(t1, $.mainLoop$closure);
},

mainLoop$bailout: function(state0, time, t1) {
  switch (state0) {
    case 0:
    case 1:
      state0 = 0;
...
render: function(delta) {
  ...
  t2.get$context2D(t1).clearRect(0, 0, t2.get$width(t1), t2.get$height(t1));
  ctx.fillStyle = "black";
  ctx.save();
  t1 = $.canvas;
  t2 = $.getInterceptor$x(t1);
  ...
  ctx.rotate($.get$p1().rotation);
  ctx.fillRect(0, 0, 10.5, 29.25);
  ctx.restore();
  $.IterableMixinWorkaround_forEach($.get$level().planets, new $.render_closure(ctx, v));
},

renderGravityMap: function() {
  var t1, t2;
  t1 = $.debugCanvas;
  t2 = $.getInterceptor$x(t1);
  t2.get$context2D(t1).clearRect(0, 0, t2.get$width(t1), t2.get$height(t1));
  $.get$context2D$x($.debugCanvas);
  t1 = $.get$level().gravity;
  t2 = $.throwNoSuchMethod("", "get x", [], null);
  if (t2 >>> 0 !== t2 || t2 >= t1.length)
    throw $.ioore(t2);
  t2 = t1[t2];
  t1 = $.throwNoSuchMethod("", "get y", [], null);
...
main_closure: {"": "Closure;",
  call$1: function(e) {
    ...
    $.get$playerController().keyEvent$2(t1.get$keyCode(e), false);
  }
},
...
main_closure0: {"": "Closure;",
  call$1: function(e) {
    var t1 = $.getInterceptor$x(e);
    t1.preventDefault$0(e);
    $.get$playerController().keyEvent$2(t1.get$keyCode(e), true);
  }
},

render_closure: {"": "Closure;ctx_0,v_1",
  call$1: function(planet) {
    var t1, pos, t2, t3, t4;
    t1 = this.v_1;
    pos = t1.$add(t1, $.$mul$n($.$sub$n(planet.get$pos(), $.get$p1().pos), 0.15));
    t1 = this.ctx_0;
    t2 = $.getInterceptor$x(planet);
    t1.fillStyle = t2.get$color(planet);
    t1.beginPath();
    t3 = pos.x;
    t4 = pos.y;
    t2 = t2.get$r(planet);
    if (typeof t2 !== "number")
      throw t2.$mul();
    t1.arc$6;
    t1.arc(t3, t4, t2 * 0.15 * 1.1, 0, 6, false);
    $.get$closePath$x(t1);
    t1.fill();
  }
}}],
...
Action: {"": "Object;value",
  ...
  static: {
"": "Action_LEFT,Action_RIGHT,Action_JUMP",
}

},

Player: {"": "Object;level<,pos<,grounded,vel,accel,facing,rotation,rotationV,actions,airTime",
  act$1: function(dt) {
    var t1, graV, t2, t3, t4, t5, wV, hV, i, nPos;
    if (typeof dt !== "number")
      return this.act$1$bailout(1, dt);
    t1 = this.airTime;
    if (t1 != null) {
      if (t1 == null)
        throw t1.$add();
    ...
    t1 = this.actions;
    t1.forEach$1(t1, new $.Player_act_closure(this));
    t1 = this.level;
    graV = t1.gravityAt$1(this.pos);
    t2 = $.getInterceptor$x(graV);
    t3 = t2.get$x(graV);
    t4 = t2.get$y(graV);
    if (typeof t3 !== "number")
      $.throwExpression(new $.ArgumentError(t3));
    ...
    t4 = Math.cos(t4);
    t5 = this.rotation;
    this.rotationV = $.Vector$(t4, Math.sin(t5));
    t4 = $.$mul$n(this.vel, 0.9);
    t5 = this.accel;
    this.vel = $.$add$ns($.$add$ns(t4, t5.$mul(t5, dt)), t2.$mul(graV, dt));
    if ($.$lt$n($.get$length$asx(this.vel), -0.9))
      t2 = new $.Vector(0, 0, null);
    else {
      t2 = $.$gt$n($.get$length$asx(this.vel), 3);
      t4 = this.vel;
      if (t2) {
        t2 = t4.normalize$0();
        t2 = t2.$mul(t2, 3);
    ...
    this.vel = t2;
    this.accel = new $.Vector(0, 0, null);
    t2 = this.rotationV.normalize$0();
    wV = t2.$mul(t2, 70);
    t2 = $.Vector$(wV.y, wV.x);
    hV = t2.$mul(t2, 195);
    i = 1;
    do {
      nPos = $.$sub$n($.$add$ns(this.pos, $.$mul$n($.$mul$n(this.vel, dt), i)), wV.$mul(wV, 0.5));
      i -= 0.2;
      t2 = $.getInterceptor$ns(nPos);
    } while ($.IterableMixinWorkaround_any([nPos, t2.$add(nPos, wV), t2.$add(nPos, hV), $.$add$ns(t2.$add(nPos, wV), hV)], new $.Player_act_closure0(this)) && i > 0);
    this.pos = t2.$add(nPos, wV.$mul(wV, 0.5));
    do
      ;
    while (false);
    t2 = this.pos;
    t4 = graV.normalize$0();
    this.grounded = t1.planetAt$1($.$add$ns(t2, t4.$mul(t4, 20)));
    if (this.grounded)
      this.airTime = null;
    else
      this.rotation = 3.141592653589793 - t3;
  },
  act$1$bailout: function(state0, dt) {
    var t1, graV, t2, t3, t4, t5, wV, hV, i, nPos;
    t1 = this.airTime;
    if (t1 != null) {
      if (t1 == null)
  ...
  move$1: function(dir) {
    var p, t1, t2;
    p = this.level.gravityAt$1(this.pos);
    t1 = $.getInterceptor$x(p);
    t1 = $.Vector$(t1.get$y(p), t1.get$x(p)).normalize$0();
    this.accel = t1.$mul(t1, 4);
    switch (dir) {
      case $.Action_0:
        t1 = this.accel;
        t2 = t1.x;
  ...
  jump$0: function() {
    ...
    if (this.airTime == null)
      this.airTime = 0;
    graV = this.level.gravityAt$1(this.pos);
    t1 = this.vel;
    t2 = graV.get$neg().normalize$0();
    this.vel = $.$add$ns(t1, t2.$mul(t2, 50));
  },
  toString$0: function(_) {
    return $.S($.$div$n($.get$x$x(this.pos), 100)) + " / " + $.S($.$div$n($.get$y$x(this.pos), 100));
  },
  static: {
"": "Player_HEIGHT,Player_WIDTH,Player_MAX_WALK_VEL,Player_MAX_FALL_VEL",
}

},

Player_act_closure: {"": "Closure;this_0",
  call$1: function(action) {
    switch (action) {
      case $.Action_0:
        this.this_0.move$1($.Action_0);
        break;
      case $.Action_1:
        this.this_0.move$1($.Action_1);
        break;
      case $.Action_2:
        this.this_0.jump$0();
        break;
...
Player_act_closure0: {"": "Closure;this_1",
  call$1: function(v) {
    return this.this_1.get$level().planetAt$1(v);
  }
}}],
["playerController", "controllers/player_controller.dart", , {
PlayerController: {"": "Object;p",
  keyEvent$2: function(keyCode, upOrDown) {
    var action, t1;
    action = null;
    switch (keyCode) {
      case 37:
...
["vector", "models/vector.dart", , {
Vector: {"": "Object;x>,y>,_liblib$_length",
  $eq: function(_, v) {
    var t1;
    if (v == null)
      return false;
    t1 = $.getInterceptor$x(v);
    return $.$eq(this.x, t1.get$x(v)) && $.$eq(this.y, t1.get$y(v));
  },
  $gt: function(_, v) {
    var t1, t2;
    if (this._liblib$_length == null) {
      t1 = this.x;
      if (typeof t1 !== "number")
      ...
      t1 += Math.pow(t2, 2);
      this._liblib$_length = Math.sqrt(t1);
    }
  ...
  $add: function(_, o) {
    var t1 = new $.Vector_operator$add_add(this);
    if (typeof o === "object" && o !== null && !!$.getInterceptor(o).$isVector)
      return t1.call$2(o.x, o.y);
    else if (typeof o === "number")
      return t1.call$1(o);
  },
  $sub: function(_, o) {
    var t1 = new $.Vector_operator$sub_sub(this);
    if (typeof o === "object" && o !== null && !!$.getInterceptor(o).$isVector)
      return t1.call$2(o.x, o.y);
    else if (typeof o === "number")
      return t1.call$1(o);
  ...
  $mul: function(_, o) {
    var t1 = new $.Vector_operator$mul_mult(this);
    if (typeof o === "object" && o !== null && !!$.getInterceptor(o).$isVector)
      return t1.call$2(o.x, o.y);
    else if (typeof o === "number")
      return t1.call$1(o);
  ...
  $div: function(_, o) {
    var t1 = new $.Vector_operator$div_div(this);
    if (typeof o === "object" && o !== null && !!$.getInterceptor(o).$isVector)
      return t1.call$2(o.x, o.y);
    else if (typeof o === "number")
      return t1.call$1(o);
  ...
  normalize$0: function() {
    var l = this.get$length(this) !== 0 ? this.get$length(this) : 1;
    return $.Vector$($.$div$n(this.x, l), $.$div$n(this.y, l));
  },
  $isVector: true,
  static: {
Vector$: function(x, y) {
  return new $.Vector($.Primitives_parseDouble($.toStringAsFixed$1$n(x, 3), null), $.Primitives_parseDouble($.toStringAsFixed$1$n(y, 3), null), null);
}}

},

Vector_operator$add_add: {"": "Closure;this_0",
  call$2: function(x, y) {
    var t1, t2, t3;
    t1 = this.this_0;
    t2 = $.getInterceptor$x(t1);
    t3 = $.$add$ns(t2.get$x(t1), x);
    t1 = t2.get$y(t1);
    return $.Vector$(t3, $.$add$ns(t1, y == null ? x : y));
  },
  call$1: function(x) {
    return this.call$2(x, null);
  }
},

Vector_operator$sub_sub: {"": "Closure;this_0",
  call$2: function(x, y) {
    var t1, t2, t3;
    t1 = this.this_0;
    t2 = $.getInterceptor$x(t1);
    t3 = $.$sub$n(t2.get$x(t1), x);
    t1 = t2.get$y(t1);
    return $.Vector$(t3, $.$sub$n(t1, y == null ? x : y));
  },
  call$1: function(x) {
    return this.call$2(x, null);
  }
...
Vector_operator$mul_mult: {"": "Closure;this_0",
  call$2: function(x, y) {
    var t1, t2, t3;
    t1 = this.this_0;
    t2 = $.getInterceptor$x(t1);
    t3 = $.$mul$n(t2.get$x(t1), x);
    t1 = t2.get$y(t1);
    return $.Vector$(t3, $.$mul$n(t1, y == null ? x : y));
  },
  call$1: function(x) {
    return this.call$2(x, null);
  }
...
Vector_operator$div_div: {"": "Closure;this_0",
  call$2: function(x, y) {
    var t1, t2, t3;
    t1 = this.this_0;
    t2 = $.getInterceptor$x(t1);
    t3 = $.$div$n(t2.get$x(t1), x);
    t1 = t2.get$y(t1);
    return $.Vector$(t3, $.$div$n(t1, y == null ? x : y));
  },
  call$1: function(x) {
    return this.call$2(x, null);
  }
...
$.mainLoop$closure = new $.Closure$mainLoop($.mainLoop, "mainLoop$closure");
...
$.Action_0 = new $.Action(0);
$.Action_1 = new $.Action(1);
$.Action_2 = new $.Action(2);
...
$.Map_empty = new $.ConstantMap(0, {}, $.List_empty0);
...
$.get$closePath$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$closePath(receiver);
};
...
Isolate.$lazy($, "level", "level", "get$level", function() {
  return $.Level$();
});
Isolate.$lazy($, "p1", "p1", "get$p1", function() {
  var t1 = new $.Player($.get$level(), new $.Vector(0, 0, null), false, new $.Vector(0, 0, null), new $.Vector(0, 0, null), $.Action_1, 0, new $.Vector(0, 0, null), new $.HashSet(0, null, null, null, null), null);
  t1.pos.move$2(0, 0);
  return t1;
});
Isolate.$lazy($, "playerController", "playerController", "get$playerController", function() {
  return new $.PlayerController($.get$p1());
});
// Native classes
...
$.defineNativeMethods("SVGAElement|SVGClipPathElement|SVGDefsElement|SVGDescElement|SVGEllipseElement|SVGGElement|SVGLineElement|SVGMarkerElement|SVGPathElement|SVGPolygonElement|SVGPolylineElement|SVGStopElement|SVGSwitchElement|SVGSymbolElement|SVGTitleElement", $.StyledElement);
...
$.defineNativeMethods("SVGLinearGradientElement", $._GradientElement);
